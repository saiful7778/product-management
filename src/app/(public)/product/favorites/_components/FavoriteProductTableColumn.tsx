...
import FavoriteProductTableRowAction from "./FavoriteProductTableRowAction";
import TableFilterHeader from "@/components/DataTable/TableFilterHeader";
import Image from "next/image";
import type { FavoriteProductType } from "@/types";

export const favoriteProductTableColumn: ColumnDef<FavoriteProductType>[] = [
  {
    id: "count",
  ...
  {
    id: "actions",
    cell: ({ row }) => <FavoriteProductTableRowAction row={row} />,
  },
];
